...
console.log('🚀 Database Schema Fix Helper');
console.log('==============================');
console.log('');
console.log('The database needs the correct column names. Please follow these steps:');
console.log('');
...
console.log('');
console.log('This will add all the missing columns with the correct names:');
console.log('✅ confidence_score (instead of confidence)');
console.log('✅ image_path (instead of image_storage_path)');
console.log('✅ raw_json (for storing AI responses)');
console.log('✅ parsed_attributes (for structured data)');
console.log('✅ analysis_model and analysis_version');
console.log('');
